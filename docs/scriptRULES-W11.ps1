...
function Show-VisualExamples {
    ...
    # DkGray
    Write-Output "$Esc[40m${FGDarkGray}DarkGray = $Esc[100m$Esc[30m$([char]0x2610)$Esc[40m${FGDarkGray} Disabled ${FGGray}| Write-Host `"$Esc[47m$Esc[30m${Char_Square}$Esc[40m$Esc[37mDisabled`" -Fg DarkGray$Reset"
