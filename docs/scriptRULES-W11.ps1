...
function Show-VisualExamples {
    ...
    # DkGray
    Write-Output "$Esc[40m${FGDarkGray}DarkGray = $Esc[40m$Esc[30m${Char_Square}$Esc[40m${FGDarkGray}Disabled ${FGGray}| Write-Host `"${Char_Square}Disabled`" -Fg DarkGray$Reset"
